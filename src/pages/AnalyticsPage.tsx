...
const defaultAnalytics = {
  totalDiscovered: 0, qualified: 0, rejected: 0, duplicates: 0, qualificationRate: 0,
  emailsQueued: 0, emailsSent: 0, failed: 0, deferred: 0, replyRate: 0,
  leadDiscoveryChart: [] as any[], qualifiedLeadsChart: [] as any[],
  emailsSentChart: [] as any[], repliesChart: [] as any[],
  qualificationDonut: [] as any[], replyClassification: [] as any[],
  keywordAnalytics: [] as any[], senderAnalytics: [] as any[],
  heatmap: [] as any[],
};
const defaultAutomation = { totalRuns: 0, avgRuntimeMinutes: 0, successRate: 0, failedJobs: 0, overruns: 0 };
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
          <KPICard label="Total Discovered" value={analytics.totalDiscovered} icon={<Users size={16} />} color="accent" />
          <KPICard label="Qualified" value={analytics.qualified} icon={<CheckCircle size={16} />} color="success" />
          <KPICard label="Rejected" value={analytics.rejected} icon={<XCircle size={16} />} color="error" />
          <KPICard label="Duplicates" value={analytics.duplicates} icon={<Copy size={16} />} color="warning" />
          <KPICard label="Qualification Rate" value={`${analytics.qualificationRate}%`} icon={<Target size={16} />} color="accent" />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          ...
          <div className="px-5 pb-5">
            <LineChart data={analytics.leadDiscoveryChart} color="#06b6d4" height={200} showArea />
        ...
        <Card>
          ...
          <div className="px-5 pb-5">
            <LineChart data={analytics.qualifiedLeadsChart} color="#10b981" height={200} showArea />
            <div className="flex items-center gap-4 mt-3">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          ...
          <div className="px-5 pb-5 flex items-center justify-center py-4">
            <DonutChart data={analytics.qualificationDonut} centerValue={String(analytics.totalDiscovered)} centerLabel="Total Leads" />
          </div>
        </Card>
        ...
        <Card>
          ...
          <div className="px-5 pb-5 flex items-center justify-center py-4">
            <DonutChart data={analytics.replyClassification} centerValue={String(analytics.emailsSent)} centerLabel="Total Replies" />
          </div>
        </Card>
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
          <KPICard label="Emails Queued" value={outreach.queued} icon={<Clock size={16} />} color="accent" />
          <KPICard label="Emails Sent" value={outreach.sent} icon={<Send size={16} />} color="success" />
          <KPICard label="Failed" value={outreach.failed} icon={<XCircle size={16} />} color="error" />
          <KPICard label="Deferred" value={outreach.deferred} icon={<Clock size={16} />} color="warning" />
          <KPICard label="Reply Rate" value={`${outreach.replyRate}%`} icon={<MessageSquare size={16} />} color="accent" />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          ...
          <div className="px-5 pb-5">
            <BarChart data={analytics.emailsSentChart} color="#06b6d4" height={200} showValues />
          </div>
        </Card>
        ...
        <Card>
          ...
          <div className="px-5 pb-5">
            <LineChart data={analytics.repliesChart} color="#06b6d4" height={200} showArea showDots />
          </div>
        </Card>
      </div>
      ...
      <Card>
        ...
        <div className="px-5 pb-5 overflow-x-auto">
          <table className="w-full">
            ...
            <tbody>
              {analytics.keywordAnalytics.map((kw, i) => (
      ...
      <Card>
        ...
        <div className="px-5 pb-5 space-y-3">
          {analytics.senderAnalytics.map((sender, i) => (
